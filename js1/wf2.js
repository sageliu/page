...
for (i = 0; i < 22; i++) {
    ...
    quotes = new Array
    quotes[1] = '<p>珥脉玄通 一周期 3盒 [邮政EMS] 已发货 请注意收货 <font color="#FF0000">√</font></p>'
    quotes[2] = '<p>珥脉玄通 两周期 6盒  [顺丰速运] 已发货 请注意收货 <font color="#FF0000">√</font></p>'
    quotes[3] = '<p>珥脉玄通 三周期 9盒  [邮箱EMS] 已发货 请注意收货 <font color="#FF0000">√</font></p>'
    quotes[4] = '<p>珥脉玄通 四周期 12盒 [顺丰速运] 已发货 请注意收货 <font color="#FF0000">√</font></p>'
    var quote = quotes[rand1]
    str += quote;
    str += '<br>';
    str += '<hr style="height:1px;border:none;border-top:1px dashed #ccc;" />';
    str += '<br>';
    //document.write(str);
    var mess = document.getElementById("wffahuo1");
    mess.innerHTML = str;
    mess.flag = true;
    //console.log(str)
    ~function () {
        var oDiv=document.getElementById("div1");
        var inner = mess.innerHTML;
        var temp = mess.scrollTop;
        ...
        if (mess.flag == true) {
            mess.scrollTop++;
            if (mess.scrollTop == temp) {
                mess.innerHTML += inner;
            }
        }
